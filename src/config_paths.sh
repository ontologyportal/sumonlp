...
export HOME="/data/angelos.toutsios.gr/Programs"

export CONDA_ENVIRONMENT="py3109_pytorch"
export SUMO_NLP_CONDA_ENVIRONMENT="$CONDA_ENVIRONMENT"
...
export MODEL_HOME="/data/angelos.toutsios.gr/Programs/$MODEL_L2L"
export CUDA_HOME="/share/apps/nvidia/cuda-12.2/lib64/"   # may not be needed
export OLLAMA_HOST_PORT="55848"   # changes default port to unique port number, can change this
...
export SIGMA_SRC="$SIGMAKEE_HOME"
export ONTOLOGYPORTAL_GIT="/data/angelos.toutsios.gr/Programs"
export SUMO_NLP_HOME="/home/angelos.toutsios.gr/workspace/sumonlp"
...
export RUNNING_ON_HAMMING=true
