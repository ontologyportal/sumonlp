...
# ✅ Correct Model Path
model_path = "/home/angelos.toutsios.gr/data/Thesis_dev/L2L_model_training/out/7-12mil-10-epochs/lightning_logs/version_0/checkpoints/epoch=8-val_bleu=0.99300.ckpt"
...
questions = [
    ...
    "The most recent glacial maximum 20,000 years ago was some 5-7 degrees Celsius colder.",
    ...
    "The International Ski and Snowboard Federation (FIS) has launched a Sustainability Guide for Ski Resorts to help such locations become more resilient in the face of rising global temperatures and lower snowfall.",
    ...
    "Early warnings are an integral part of climate change adaptation and disaster risk reduction.",
    ...
    "A shift to a 2 degree Celsius pathway requires immediate significant and sustained global mitigation, with a probable reliance on net negative emissions in the longer term.",
    ...
    "Though the CCP was responsible for about 12 percent of cumulative global emissions since the start of the Industrial Revolution to 2017—compared to 25 percent for the United States and 22 percent for the European Union and United Kingdom—it now emits about a third of the world's greenhouse gases each year, well ahead of any other economy.",
...
transformed_questions = [prefix + q for q in questions]

# ✅ Prepare Inputs
inputs = tokenizer(transformed_questions,
                   return_tensors="pt",
                   padding=True,
                   truncation=True,
                   ).to(model.device)
...
with open("output.csv", "w", encoding="utf-8") as f:
    ...
    for inp, pred in zip(transformed_questions, outputs):
