...
paragraph = '''to lead is to preside over'''
doc1 = nlp1(paragraph)
doc2 = nlp2(paragraph)
...
# print('------------------------------------------------------------')
print(*[f'word: {word.text}\t word_lemma: {word.lemma}\t word_pos: {word.upos}' for sent in doc1.sentences for word in sent.words], sep='\n')
