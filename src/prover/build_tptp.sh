#!/bin/bash
java -Xmx8g -classpath $SIGMA_SRC/build/sigmakee.jar:$SIGMA_SRC/lib/* com.articulate.sigma.trans.SUMOformulaToTPTPformula -g "$(< $HOME/workspace/sumonlp/src/prover/input_pr.txt)" > $HOME/.sigmakee/KBs/temp.fof
